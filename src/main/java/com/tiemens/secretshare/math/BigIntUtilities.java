...
public final class BigIntUtilities {
  ...
  // ==================================================
  /**
   * Converter class : "Human" Input format : Any (human readable) string
   * Example input : "This is my cat" gives BigInteger :
   * 1711994770713785234966317640147316
   */
  public static class Human {

    /**
     * Convert a "human string" into a BigInteger by using the string's
     * byte[] array. This is NOT EVEN CLOSE to the same as new
     * BigInteger("string").
     *
    ...
    /**
     * @param in the BigInteger whose bytes to use for the String usually
     * the output of 'createBigInteger()', above.
  ...
  /**
   * Converter class : "Bigint Checksum" Input format : String that starts
   * with "bigintcs:", contains Hex groups Example input :
   * bigintcs:005468-697320-697320-6d7920-636174-D23FBD gives BigInteger :
   * 1711994770713785234966317640147316
   */
  public static class Checksum {
     ...
     * @return true if this value is a big-int-checksum string (i.e. starts
     * with "bigintcs:") false otherwise
     */
    ...
    /**
     * @param hexStringWithMd5sum the bigintcs:hhhhh-CCCCCC string
     * representation
     * @return the bigintstringchecksum
     * @throws SecretShareException on error
     */
    public static BigIntStringChecksum createBiscs(
            final String hexStringWithMd5sum) {
  ...
  /**
   * Converter class : "Hex" Input format : String that starts with "0x",
   * contains 0-9A-Fa-f only Example input : 0x54686973206973206d7920636174
  ...
  public static class Hex {
    ...
    /**
     * @param value string to test
     * @return true if this value is a hex-encoded string (i.e. starts with
     * "0x")
     */
    ...
    public static BigInteger createBigInteger(String value) {
      ...
      if (couldCreateFromStringHex(value)) {
        ...
        throw new SecretShareException("value must start with '0x' (input='"
                + value + "')");
      }
    }
  ...
  public static BigInteger createPrimeBigger(
          BigInteger valueThatDeterminesNumberOfBits) {
